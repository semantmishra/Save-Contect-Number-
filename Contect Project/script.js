...
///	 Word count function 
  function ti(){
	  alert("hjhjhj");
var key = document.getElementById("atical_t").value;
document.getElementById("t").innerHTML=key.length;
}
function ma(){
var desc = document.getElementById("article").value;
document.getElementById("m").innerHTML=desc.length;
}
/// end Worrd count function 
/*
function AT(){
	if(document.getElementById("atical_t").value==""){
		document.getElementById("atical_t").style.borderColor="red";
		return false ;
		}else {
			document.getElementById("atical_t").style.borderColor="";
			return true ;
				}
	}
...
function Articale(){
	if(document.getElementById("article").value==""){
		document.getElementById("article").style.borderColor="red";
		return false ;
		}else {
			document.getElementById("article").style.borderColor="";
			return true ;
		}
	}
	function onSubmitf(){
		if ( AT() == true && Articale() == true )
		{return true;}
		else
		{return false;}
